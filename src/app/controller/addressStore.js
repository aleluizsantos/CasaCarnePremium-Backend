...
router.post('/create', async (req, res) => {
    const { cep, address, number, neighborhood, city, uf, phone, latitude, longitude, active, } = req.body;
    const user_id = req.userId;
...
router.delete('/delete/:id', async (req, res)=> {
    ...
    const responseDelete = await connection('addressStore').where({id: id}).delete();
